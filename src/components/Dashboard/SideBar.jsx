  ...
  return (
    <>
      <div className="col-start-1">
        ...
        <div
          className={`${
            mymenu ? "top-[80px] opacity-100 pb-6 w-screen" : "hidden md:block"
          } block md:justify-between  md:items-center md:static absolute md:bg-transparent bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:mr-20`}
        >
          <div className="w-[320px] bg-primary hover:bg-text_primary h-[80px] flex items-center px-5 mt-6 ml-2 rounded">
            {/* <img src={auth.userImg} alt="" /> */}
          ...
          <aside className="mx-6 mt-10">
            <ul className="">
              ...
              >
                ...
                <span className={`${!menu && "hidden"}`}>
                  <IoIosArrowUp className="h-6 w-6 mr-3 stroke-primary" />
                </span>
              </li>
              <ul
                className={`${
              ...
              >
                ...
                <span className={`${codeMenu && "hidden"}`}>
                  <IoIosArrowDown className="h-6 w-6 mr-3 stroke-primary" />
                </span>
                <span className={`${!codeMenu && "hidden"}`}>
                  <IoIosArrowUp className="h-6 w-6 mr-3 stroke-primary" />
