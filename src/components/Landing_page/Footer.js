      ...
      <footer className="footer w-full md:h-[425px] bg-[#505050] p-8">
        ...
        <div className="block md:flex w-80 md:justify-between md:items-center md:w-[800px] mx-auto ">
          ...
          <div className="mx-auto my-9 md:my-5">
            <input
              type="text"
              className="md:w-[350px] mx-7 bg-transparent border-b-gray-400 border-b-2 border-t-0 border-l-0 border-r-0 focus:outline-none focus:ring focus:border-white text-2xl "
              placeholder="subscribe to email updates"
            />
          </div>
          <div className="mx-auto w-40  mt-10 md:mr-12 md:my-5 ">
            <button className="w-[152px] h-[40px] bg-primary text-white">
              Submit
            </button>
          </div>
        </div>
